...
function renderAbout(container) {
    ...
    <section class="about">
      <h2>About Us</h2>
      <p>
        Welcome to our Medical Appointment System. Our mission is to simplify the process of scheduling appointments with healthcare professionals.
      </p>
      <p>
        Contact us at <strong>+506 5467 0937</strong> or visit our offices for assistance.
      </p>
    </section>
  `;
}
